...
public class CustomContainerEnchantTable extends Container {
    ...
    public IInventory enchantSlots = new InventorySubcontainer("Enchant", true, 2) {
        ...
        public void update() {
            super.update();
            CustomContainerEnchantTable.this.a((IInventory) this);
        }

        // CraftBukkit start
        @Override
        public Location getLocation() {
            return new org.bukkit.Location(Bukkit.getWorld("world"), 0, 0, 0);
        }
        // CraftBukkit end
    };
//    public World world;
//    private final BlockPosition position;
    ...
    public CustomContainerEnchantTable(PlayerInventory playerinventory) {
    ...
    public void a(IInventory iinventory) {
        if (iinventory == this.enchantSlots) {
            ...
            if (!itemstack.isEmpty()) { // CraftBukkit - relax condition
                    ...
                    PrepareItemEnchantEvent event = new PrepareItemEnchantEvent(player, this.getBukkitView(), null, item, offers, i);
        ...
        if ((itemstack1.isEmpty() || itemstack1.getCount() < j) && !entityhuman.abilities.canInstantlyBuild) {
            return false;
                ...
                if (true || !list.isEmpty()) {
                    ...
                    EnchantItemEvent event = new EnchantItemEvent((Player) entityhuman.getBukkitEntity(), this.getBukkitView(), null, item, this.costs[i], enchants, i);
